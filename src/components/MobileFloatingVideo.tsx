...
interface MobileFloatingVideoProps {
  socket: any;
  userId: string;
  sessionId: string;
  isMentor: boolean;
...
export function MobileFloatingVideo({ socket, userId, sessionId, isMentor }: MobileFloatingVideoProps) {
  ...
  return (
    <>
      {/* Start Call Button - Mobile */}
      {!isCallActive && (
        <button
          onClick={startCall}
          className="fixed bottom-4 left-4 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-full shadow-lg transition flex items-center gap-2 z-30"
        >
      ...
      {/* Floating Video Container - Mobile Only */}
      {isCallActive && (
        <div className="fixed bottom-4 left-4 right-4 z-40">
          <div className="relative bg-gray-900 rounded-xl shadow-2xl overflow-hidden border-2 border-blue-500">
            ...
            <div className="relative aspect-video">
              ...
              {/* Local Video (PiP) */}
              <div className="absolute bottom-2 right-2 w-24 h-20 bg-gray-800 rounded-lg overflow-hidden border-2 border-white shadow-lg">
                <video
                  ref={localVideoRef}
                  autoPlay
                  muted
            ...
            {showControls && (
              ...
              >
                ...
                <p className="text-white text-xs">Tap outside to hide</p>
              </div>
            )}
